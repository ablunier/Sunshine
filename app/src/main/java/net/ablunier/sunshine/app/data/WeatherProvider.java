package net.ablunier.sunshine.app.data;
...
/**
 * Created by ablunier on 8/21/14.
 */
public class WeatherProvider extends ContentProvider {
    ...
    private static final String sLocationSettingWithDaySelection = WeatherContract.LocationEntry.TABLE_NAME + "." + WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING + " = ? AND " + WeatherContract.WeatherEntry.COLUMN_DATETEXT + " = ? ";
